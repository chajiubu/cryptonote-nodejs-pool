...
function loadTranslations() {
    if (langData) {
        ...
        $.getJSON('/pools/common/lang/'+langCode+'.json', translate);
        $.getScript('/pools/common/lang/timeago/jquery.timeago.'+langCode+'.js');
    } else {
        $.getJSON('/pools/common/lang/'+defaultLang+'.json', translate);
        $.getScript('/pools/common/lang/timeago/jquery.timeago.'+defaultLang+'.js');
    }
}
